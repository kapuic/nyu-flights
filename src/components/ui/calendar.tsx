...
const calendarRtlNextIconClassName = String.raw`rtl:**:[.rdp-button\_next>svg]:rotate-180`
const calendarRtlPreviousIconClassName = String.raw`rtl:**:[.rdp-button\_previous>svg]:rotate-180`
...
function CalendarChevron({
  ...
  orientation,
  ...props
}: { className?: string; orientation?: string } & React.ComponentProps<
  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        calendarRtlNextIconClassName,
        calendarRtlPreviousIconClassName,
        className
      )}
